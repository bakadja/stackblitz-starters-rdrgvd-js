...
const day_plus_un = dayjs('2024-02-12T14:51:40.000Z').add(1, 'day');
console.log(day_plus_un);
console.log(day_plus_un.format());

console.log(dayjs('2024-02-12T14:51:40.000Z').add(2, 'day'));
